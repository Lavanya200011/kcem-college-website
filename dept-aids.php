...
<head>
    ...
    <title>AI & Data Science | KCEM Sakoli</title>
    ...
    <nav class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <img src="images/ai.jpg" alt="AI Logo" class="h-12 w-12 rounded-lg object-cover shadow-sm">
                <div>
                    <h1 class="text-lg font-bold text-indigo-950 leading-tight">Dept. of AI & Data Science</h1>
                    <p class="text-xs text-purple-600 font-bold uppercase tracking-widest">KCEM Sakoli</p>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10 animate-reveal">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                <div class="lg:w-2/3 text-center lg:text-left">
                    <span class="bg-purple-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-6 inline-block">Future-Ready Technology</span>
                    <h2 class="text-4xl md:text-5xl font-black mb-6 leading-tight">Mastering <span class="text-purple-400">Intelligence</span>,<br>Decoding <span class="text-purple-400">Data</span></h2>
                    <p class="text-indigo-100 text-lg mb-8 max-w-2xl leading-relaxed opacity-90">
                        Blending machine learning, deep learning, and statistical modeling to shape the future of intelligent systems and data-driven innovation.
                    </p>
                    <div class="flex flex-wrap justify-center lg:justify-start gap-4">
                        ...
                        <div class="bg-white/10 border border-white/20 px-6 py-3 rounded-2xl hover:bg-white/20 transition-colors cursor-default">
                            ...
                            <p class="text-xl font-bold">Neural Networks</p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/3 flex justify-center">
                    <div class="relative group">
                        ...
                        <img src="images/dept-aids.jpg" alt="AI Visualization" class="relative rounded-3xl shadow-2xl border-4 border-white/20 w-80 h-auto transform group-hover:scale-105 transition-transform duration-500">
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="max-w-7xl mx-auto px-4 -mt-10 relative z-20 pb-20">
        ...
        <section class="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 md:p-12 mb-16 flex flex-col md:flex-row gap-12 items-center animate-reveal" style="animation-delay: 0.2s;">
            <div class="w-full md:w-1/3 shrink-0">
                <div class="relative group">
                    ...
                    <img src="images/HOD_AIDS.jpg" alt="HOD AI" class="relative rounded-2xl w-full h-[350px] object-cover shadow-lg transition-transform duration-500 group-hover:scale-[1.02]">
                </div>
            </div>
            <div class="w-full md:w-2/3 relative">
                ...
                <h3 class="text-purple-600 font-bold text-xl mb-6">Mrs. Vaishali G. Mohature</h3>
                <p class="text-slate-600 leading-relaxed italic text-lg mb-6">
                    "Welcome to the forefront of innovation. Our program is designed to develop proficient AI engineers and research professionals capable of solving complex problems and driving digital transformation across industries globally."
                </p>
                <div class="flex items-center gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            ...
            <div class="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 group">
                ...
                <h3 class="text-xl font-bold mb-4 group-hover:text-purple-700 transition-colors">Core AI Labs</h3>
                <ul class="text-slate-500 space-y-3 text-sm">
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> GPU-Accelerated Computing</li>
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> Big Data Analytics Hub</li>
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> Natural Language Processing Lab</li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 group border-b-4 border-b-purple-500">
                ...
                <ul class="text-slate-500 space-y-3 text-sm">
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> 2000+ AI & Data Technical Books</li>
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> IoT & Robotics Kits</li>
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> Virtual Cloud Servers Access</li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 group">
                ...
                <ul class="text-slate-500 space-y-3 text-sm">
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> AI Hackathons & Challenges</li>
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> Industry 4.0 Internships</li>
                    <li class="flex items-center gap-2"><i data-lucide="check-circle" class="w-4 h-4 text-purple-500"></i> Placement in Data Science roles</li>
                </ul>
            </div>
        </div>
    </main>
